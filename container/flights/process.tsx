...
import { processimg01, processimg02, processimg03 } from "@/public";
					...
					<div className="w-full flex gap-5 justify-between">
						<div className="w-full grid grid-cols-5 items-center justify-between gap-5">
							<div className="w-full flex flex-col items-center justify-center gap-3">
								...
								<p className="text-base text-muted-foreground font-normal leading-tight text-center">
